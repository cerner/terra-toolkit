...
- [DefinePlugin](https://webpack.js.org/plugins/define-plugin/) - Plugin to define global compile-time values, including:
  ...
  - `TERRA_THEME_CONFIG` - The scoped and default theme from
...
```
Read more on webpack's doc site[webpack environment options](https://webpack.js.org/api/cli/#environment-options)
...
|---|---|---|
|`THEME`|String|Override the default theme set in the terra-theme.config.js file. Useful for testing.|
