...
|-------------------------------|---------|----------|-----------|-------------------------------------------------------------------------------------------------------------------------------------------|
| BROWSERS                      | string  | true     |           | A list of browsers for the test run. Browsers are delimited by a comma. Example: chrome,firefox,ie                                        |
| FORM_FACTOR                   | string  | true     |           | A form factor assigned to the test run.                                                                                                   |
| LOCALE                        | string  | true     |           | A locale assigned to the test run.                                                                                                        |
...
| THEME                         | string  | true     |           | A theme name assigned to the test run.                                                                                                    |
| WDIO_DISABLE_SELENIUM_SERVICE | boolean |          |           | A flag to disable the selenium docker service.                                                                                            |
