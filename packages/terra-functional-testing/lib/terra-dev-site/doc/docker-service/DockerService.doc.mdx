...
```js
// wdio.conf.js
const SeleniumDockerService = require('@cerner/terra-functional-testing/services/wdio-selenium-docker-service');
...
The docker selenium image to run tests against.
