...
class TerraVerboseReporter extends VerboseReporter {
  constructor(globalConfig) {
    console.log('reached inside the TerraVerboseReporter *************');
    super(globalConfig);
    this.results = {
      startDate: '',
      output: {},
  ...
  log(message) {
    ...
    console.log('this.results.output ::: ', JSON.stringify(this.results, null, 2));
  }
  ...
  onRunComplete() {
    ...
    if (output && moduleKeys.length) {
      moduleKeys.forEach((key) => {
        ...
        console.log(`_______________${this.moduleName}_____________________________`);
        // console.log('filePathLocation ::::::::::::::::: ', filePathLocation);
