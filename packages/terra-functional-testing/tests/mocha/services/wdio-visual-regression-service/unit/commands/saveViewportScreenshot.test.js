...
import saveViewportScreenshot from '../../../../../../src/services/wdio-visual-regression-service/commands/saveViewportScreenshot';
// Note: we import this that way to allow sinon to stub the default method
import * as makeViewportScreenshot from '../../../../../../src/services/wdio-visual-regression-service/modules/makeViewportScreenshot';
...
describe('saveViewportScreenshot', function() {
  ...
  it('works correctly when called without args', async function() {
    ...
    const {
      args: [browser, options],
    } = this.makeViewportScreenshot.firstCall;
