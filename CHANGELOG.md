...
* Updated clean-webpack-plugin dependency. Webpack config and jest test syntax updated to reflect v3 export changes, see https://github.com/johnagan/clean-webpack-plugin/releases/tag/v3.0.0
