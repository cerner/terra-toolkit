import TrimAndMergeScreenshotStrategy, { consts } from '../../../../../../../lib/services/wdio-terra-visual-regression/utils/strategies/TrimAndMergeScreenshotStrategy';
import ScreenDimension from '../../../../../../../lib/services/wdio-terra-visual-regression/utils/ScreenDimension';
  ...
  context('full page', function() {
    it('handles vertical scroll & crop', function() {
      ...
      const steps = [
        ...
        {
          scroll: {
            x: 0, y: 768 - consts.NAV_SHADOW_CONST_COMBINED, indexX: 0, indexY: 1,
          },
          crop: {
            ...crop,
        ...
        {
          scroll: {
            x: 0, y: 1536 - consts.NAV_SHADOW_CONST_COMBINED * 2, indexX: 0, indexY: 2,
          },
          crop: {
            ...crop,
    ...
    it('handles horizontal & vertical scroll & crop', function() {
      ...
      const steps = [
        ...
        {
          scroll: {
            x: 1024, y: 768 - consts.NAV_SHADOW_CONST_COMBINED, indexX: 1, indexY: 1,
          },
          crop: {
            ...crop,
            height: screenDimensions.getViewportHeight() - consts.NAV_SHADOW_CONST_COMBINED,
        ...
        {
          scroll: {
            x: 2048, y: 768 - consts.NAV_SHADOW_CONST_COMBINED, indexX: 2, indexY: 1,
          },
          crop: {
            ...crop,
            height: screenDimensions.getViewportHeight() - consts.NAV_SHADOW_CONST_COMBINED,
        ...
        {
          scroll: {
            x: 1024, y: 1536 - consts.NAV_SHADOW_CONST_COMBINED * 2, indexX: 1, indexY: 2,
          },
          crop: {
            ...crop,
            height: 164 + consts.NAV_SHADOW_CONST * 3,
        ...
        {
          scroll: {
            x: 2048, y: 1536 - consts.NAV_SHADOW_CONST_COMBINED * 2, indexX: 2, indexY: 2,
          },
          crop: {
            ...crop,
            width: 452,
  ...
  context('area specific screenshots', function() {
    it('handles vertical scroll & crop', function() {
      ...
      const steps = [
        ...
        {
          scroll: {
            x: 500, y: 968 - consts.NAV_SHADOW_CONST_COMBINED, indexX: 0, indexY: 1,
          },
          crop: {
            ...crop,
            width: 200,
    ...
    it('handles horizontal & vertical scroll & crop', function() {
      ...
      const steps = [
        ...
        {
          scroll: {
            x: 1524, y: 968 - consts.NAV_SHADOW_CONST_COMBINED, indexX: 1, indexY: 1,
          },
          crop: {
            ...crop,
            width: 376,
    ...
    context('full page', function() {
      it('handles vertical scroll & crop', function() {
        ...
        const crop = {
          ...
          height: Math.round(
            (screenDimensions.getViewportHeight() - consts.NAV_SHADOW_CONST) * screenDimensions.getScale(),
          ),
          x: 0,
          y: 0,
          rotation: 0,
        ...
        const steps = [
          ...
          },
          {
            scroll: {
              x: 0,
              y: screenDimensions.getViewportHeight() - consts.NAV_SHADOW_CONST_COMBINED,
              indexX: 0,
              indexY: 1,
            },
            crop: {
              ...crop,
              height: Math.round(
                (screenDimensions.getDocumentHeight()
                  - (screenDimensions.getViewportHeight() - consts.NAV_SHADOW_CONST))
                  * screenDimensions.getScale(),
              ),
              y: consts.NAV_SHADOW_CONST,
            },
          },
      ...
      it('handles vertical scroll & crop', function() {
        ...
        const steps = [
          ...
          },
          {
            scroll: {
              x: 500,
              y: 200 + screenDimensions.getViewportHeight() - consts.NAV_SHADOW_CONST_COMBINED,
              indexX: 0,
              indexY: 1,
            },
            crop: {
