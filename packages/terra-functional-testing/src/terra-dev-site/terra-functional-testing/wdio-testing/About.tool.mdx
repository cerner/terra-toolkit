...
| --externalPort                   | number  | 8080                    | The port mapping from the host to the container.                                                                                          |
...
| --internalPort                   | number  | 8080                    | The port to run the webpack and express asset services on.                                                                                |
