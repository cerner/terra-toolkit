...
import saveDocumentScreenshot from '../../../../../../src/services/wdio-visual-regression-service/commands/saveDocumentScreenshot';
// Note: we import this that way to allow sinon to stub the default method
import * as makeDocumentScreenshot from '../../../../../../src/services/wdio-visual-regression-service/modules/makeDocumentScreenshot';
...
describe('saveDocumentScreenshot', function() {
  ...
  it('works correctly when called without args', async function() {
    ...
    } = this.makeDocumentScreenshot.firstCall;
