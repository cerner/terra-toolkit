...
class TestRunner {
   ...
   * @param {string} options.seleniumServiceUrl - The address for selenium service.
   * @param {number} options.port - The port mapping for selenium service.
   ...
   * @param {string} options.gridUrl - The remote selenium grid address.
   * @param {string} options.seleniumServiceUrl - The address for docker selenium hub.
   * @param {number} options.port - The port mapping for docker selenium hub.
   * @param {boolean} options.keepAliveSeleniumDockerService - Determines to keep the selenium docker service running upon test completion.
