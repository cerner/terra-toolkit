...
Below is an example of terra-theme.config. See [theme config](/dev_tools/terra-toolkit-docs/webpack-config-terra/theme-config) for more details about the object structure.
