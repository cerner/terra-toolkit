...
describe('Theme Aggregator', () => {
  ...
  describe('aggregate', () => {
    it('returns null if there is no terra-theme-config.js and no config passed by env var.', () => {
      ...
      // expect.assertions(1);
      // return ThemeAggregator.aggregate(null)
      //   .then((file) => {
      //     expect(file).toBeNull();
        // });
    });
    ...
    it('uses the supplied config', () => {
      ...
      // expect.assertions(1);
      // return ThemeAggregator.aggregate(null, { config })
      //   .then((file) => {
      //     expect(file).toEqual(expected);
      //   });
    });
    ...
    it('overrides the supplied config', () => {
      ...
      expect(file).toEqual(expected);
      // expect.assertions(1);
      // return ThemeAggregator.aggregate('terra-mock-rainbow-theme', { config })
      //   .then((file) => {
      //     expect(file).toEqual(expected);
      //   });
    });
  ...
  //     glob
  //       .mockReturnValueOnce(['tests/jest/fixtures/themes/terra-mock-solar-theme/root-theme.scss'])
  //       .mockReturnValueOnce([])
  ...
  //     expect.assertions(1);
  //     return ThemeAggregator.triggerAggregationAndGeneration('')
  //       .then((files) => {
  //         expect(files).toEqual([]);
  //       });
  //   });
  ...
  //     // expect(files).toEqual(expected);
  //     expect.assertions(1);
  //     return ThemeAggregator.triggerAggregationAndGeneration('terra-mock-dark-theme', options, true)
  //       .then((files) => {
  //         expect(files).toEqual(expected);
  //       });
  //   });
  ...
  //     // expect(files).toEqual(expected);
  //     expect.assertions(1);
  //     return ThemeAggregator.triggerAggregationAndGeneration('terra-mock-dark-theme', options, false)
  //       .then((files) => {
  //         expect(files).toEqual(expected);
  //       });
  //   });
  ...
  //     // expect(files).toEqual(expected);
  //     expect.assertions(1);
  //     return ThemeAggregator.findThemeVariableFilesForGeneration(themeName)
  //       .then((files) => {
  //         const expected = ['tests/jest/fixtures/themes/terra-mock-dark-theme/terra-mock-dark-theme.scss'];
  //         expect(files).toEqual(expected);
  //       });
  ...
  //     glob
  //       .mockReturnValueOnce(['./tests/jest/fixtures/themes/terra-mock-dark-theme/']);
  //     const options = {};
  ...
  //     expect.assertions(1);
  //     return ThemeAggregator.generateTheme('terra-mock-dark-theme', false, [], outputPath)
  //       .then((generatedScssFilePath) => {
