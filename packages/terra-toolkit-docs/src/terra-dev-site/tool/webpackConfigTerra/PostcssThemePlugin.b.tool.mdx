...
Below is an example of terra-theme.config. See [theme config](/dev_tools/terra-toolkit-docs/webpack-config-terra/terra-theme-config-js) for more details about the object structure.
